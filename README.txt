...
rtiddsgen robot.idl -D BASIC -D REDEFINE_DDS_TYPES -namespace -language C++ -replace

rtiddsgen rpc_types.idl -D BASIC -D REDEFINE_DDS_TYPES -namespace -language C++ -replace
